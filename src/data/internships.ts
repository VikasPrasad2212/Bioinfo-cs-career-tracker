...
export const INITIAL_INTERNSHIPS: InternshipOpportunity[] = [
  ...
  {
    id: 'popvax-computational-immunology-intern',
    title: 'Computational Immunology & mRNA Vaccine Design Intern',
    organization: 'PopVax',
    category: 'biotech_startup',
    location: 'Hyderabad (Genome Valley) / Remote',
    workMode: 'Hybrid',
    stipend: '₹35,000 - ₹50,000 / month',
    duration: '3 to 6 Months (Convertible)',
    deadline: 'Rolling (Immediate Start)',
    status: 'Open',
    csSkills: ['Python', 'PyTorch / JAX', 'Transformers', 'Algorithms', 'High-Performance Computing', 'Git'],
    bioFocus: ['mRNA Design', 'Epitope Prediction', 'Protein Language Models (ESM-2)', 'Broadly Neutralizing Antibodies'],
    description: 'Join PopVax—an ambitious mRNA and protein-design biotech backed by top global funders (including the Bill & Melinda Gates Foundation). You will build deep learning pipelines to design broadly neutralizing mRNA vaccines against rapidly mutating pathogens (Coronaviruses, Dengue, Influenza).',
    csCandidateAdvantage: 'PopVax specifically targets Computer Science, Machine Learning, and Mathematics graduates to apply Transformer architectures and protein language models to immune recognition optimization.',
    applicationProcedure: 'Apply directly via PopVax Careers page or email your GitHub and CV to the computational biology hiring team.',
    applicationUrl: 'https://popvax.com/careers',
    contactEmail: 'careers@popvax.com',
    isVerified: true,
    postedDate: '2026-08-28',
    featured: true,
  },
  {
    id: 'pandorum-tissue-bioinformatics',
    title: 'AI & Biomaterials Modeling Intern',
    organization: 'Pandorum Technologies',
    category: 'biotech_startup',
    location: 'Bengaluru',
    workMode: 'Hybrid',
    stipend: '₹25,000 - ₹35,000 / month',
    ...
    deadline: 'Rolling',
    status: 'Open',
    csSkills: ['Python', 'C++', 'Finite Element Modeling', 'Computer Vision', 'PyTorch'],
    bioFocus: ['Regenerative Medicine', 'Tissue Bio-printing', 'Organoid Imaging Analytics'],
    description: 'Work at the intersection of tissue engineering, regenerative medicine, and computational modeling. Develop AI algorithms for 3D bioprinting pattern generation and image analytics for cell survival monitoring.',
    csCandidateAdvantage: 'Algorithms for spatial geometric modeling, fluid dynamics simulation, and computer vision segmentation.',
    applicationProcedure: 'Submit portfolio and resume on Pandorum Technologies career portal.',
    applicationUrl: 'https://pandorumtechnologies.com/careers/',
    contactEmail: 'careers@pandorumtechnologies.com',
    isVerified: true,
    postedDate: '2026-08-27',
  },
  {
    id: 'ganit-labs-genomic-algorithms',
    title: 'Genomics Software Engineer & Algorithm Trainee',
    organization: 'Ganit Labs (Bio-IT Consortium)',
    category: 'gov_research',
    location: 'Bengaluru',
    workMode: 'On-site',
    ...
    deadline: 'Nov 20',
    status: 'Open',
    csSkills: ['C/C++', 'Python', 'Data Structures & Algorithms', 'Linux Kernel / System Optimization'],
    bioFocus: ['Next-Generation Sequencing Aligners', 'Variant Detection Algorithms', 'Bio-IT Systems'],
    description: 'Help develop ultra-fast open-source sequence alignment algorithms, indexing data structures (BWT, FM-index), and genomic compression utilities.',
    csCandidateAdvantage: 'Direct implementation of core computer science algorithms (string matching, bit manipulation, cache optimization).',
    applicationProcedure: 'Apply via Bio-IT consortium careers portal or direct email to lab directors.',
    applicationUrl: 'http://www.ganitlabs.in/',
    contactEmail: 'info@ganitlabs.in',
    isVerified: true,
    postedDate: '2026-08-26',
  },
  {
    id: 'premas-biotech-structure-intern',
    title: 'Structural Bioinformatics & Bioprocess Data Intern',
    organization: 'Premas Biotech',
    category: 'biotech_startup',
    ...
    deadline: 'Dec 05',
    status: 'Open',
    csSkills: ['Python', 'SQL', 'R', 'FastAPI / Flask', 'Docker'],
    bioFocus: ['Biomanufacturing Analytics', 'Protein Expression Modeling', 'Kinetic Simulation'],
    description: 'Build automated data pipelines that monitor bioreactor sensor telemetry and model recombinant protein expression yields using machine learning.',
    csCandidateAdvantage: 'Time-series predictive modeling, relational database design, and sensor telemetry analytics.',
    applicationProcedure: 'Apply on Premas Biotech portal or email HR with sample predictive analytics projects.',
    applicationUrl: 'https://www.premasbiotech.com/careers/',
    contactEmail: 'careers@premasbiotech.com',
    isVerified: true,
    postedDate: '2026-08-25',
  }
];
